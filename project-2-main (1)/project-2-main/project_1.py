...
yw=ImageTk.PhotoImage((Image.open("profile.jpg")))
yww=ImageTk.PhotoImage((Image.open("profile.jpg")))
...
def tim(youwin):
    ...
    while True:
        try:
            ...
            return
iim=ImageTk.PhotoImage((Image.open("profile.jpg")))
iimw=ImageTk.PhotoImage((Image.open("profile.jpg")))
...
_a89=ImageTk.PhotoImage((Image.open("profile.jpg")))
a89=Label(t,image=_a89)
a89.place(x=600,y=600,width=50,height=50)
from tkinter import messagebox
from tkinter import filedialog
cti=ImageTk.PhotoImage((Image.open("profile.jpg")))
ctiw=ImageTk.PhotoImage((Image.open("profile.jpg")))
...
introi=[ImageTk.PhotoImage(Image.open("profile.jpg").resize((300,300))),ImageTk.PhotoImage(Image.open("profile.jpg").resize((300,300))),ImageTk.PhotoImage(Image.open("profile.jpg").resize((300,300)))]
